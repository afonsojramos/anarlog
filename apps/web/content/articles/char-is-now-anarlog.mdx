...
meta_description: "The AI meeting notetaker you've been using is now Anarlog — open source, MIT-licensed, and local-first, with a free plan and optional paid plans. Char is a different product now: an AI notepad that finishes your todos. Two names because they're two different products."
author: "John Jeong"
featured: true
...
- Free local meeting notes with on-device models or your own API keys, plus optional [Pro, Team, and Enterprise plans](/pricing/) for hosted AI, sync, collaboration, and organization-wide controls
