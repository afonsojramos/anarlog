...
meta_description: "The AI meeting notetaker you've been using is now Anarlog — open source, MIT-licensed, and free for unlimited local use. Char is a different product now: an AI notepad that finishes your todos. Two names because they're two different products."
author: "John Jeong"
featured: !!bool "true"
...
- Free for unlimited local meeting notes, with on-device models or your own API keys
